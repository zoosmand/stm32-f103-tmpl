...
/* Private variables ---------------------------------------------------------*/
static uint16_t maxData[(MAX7219_SEG_CNT_ * 8)];
...
int MAX7219_Init(SPI_TypeDef* SPIx) {
  ...
  const uint16_t maxInit[15] = {
    ...
    0x0a00, // 0x0a - Intensity,    0x00 - lowest, 0x0f - highest
  ...
  SPI_Enable(SPIx, SPIBufLen_16bit);
  ...
  for (uint8_t i = 0; i < 15; i++) {
    ...
    NSS_0_L;
    while (seg--) {
      if (MAX7219_WriteBus(SPIx, maxInit[i])) return (1);
    }
    // _NSS_H(SPInss);
    NSS_0_H;
  }
...
//  Delay_us(10);
//  _NSS_L;
//  MAX7219_WriteBus(0x0101);
//  MAX7219_WriteBus(0x0102);
//  MAX7219_WriteBus(0x0103);
//  MAX7219_WriteBus(0x0104);
//  _NSS_H;

//  Delay_us(10);
//  _NSS_L;
//  MAX7219_WriteBus(0x0201);
//  MAX7219_WriteBus(0x0202);
//  MAX7219_WriteBus(0x0203);
//  MAX7219_WriteBus(0x0204);
//  _NSS_H;
//  
//  Delay_us(10);
//  _NSS_L;
